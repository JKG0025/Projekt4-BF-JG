...
constexpr int SPACING = 22; // Spacing between passengers in the elevator
constexpr int OFFSET_BASE = 20; // Base offset for repositioning passengers on the floor
...
constexpr int ANIMATION_DELAY_MS = 100; // Delay after moving the elevator sprite
